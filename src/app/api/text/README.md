...
<img width="1062" alt="Screen Shot 2023-07-10 at 11 08 55 PM" src="https://github.com/a16z-infra/bot-app/assets/3489963/d7905f13-a83a-47f8-ac74-b66698d4292b">


g. Add your Twilio phone number in `bots.json` under the bot you want to text with. Make sure you include area code when adding the phone number ("+14050000000" instead of "4050000000")
...
simply add a description to the list in `bots.json`. You can control the model used
...
[appenz](https://github.com/appenz) has contributed to a Python implementation for the bot app [here](https://github.com/a16z-infra/bot-app/tree/python-local/python), so you also have the option to run a local Python app and talk to your AI bots on the command line. We will also be iterating on the Python side over time and have feature parity with the typescript implementation.
...
- `[bot_NAME_]_character_ai_data.txt`: This outputs the data you need in order to re-create the bot on Character.ai. You can find Character.ai character configurations under "View Character Settings" on any newly-created characters.
